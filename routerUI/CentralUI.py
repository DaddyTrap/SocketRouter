...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.ForwardTable.setGeometry(QtCore.QRect(10, 300, 461, 121))
        self.ForwardTable.setObjectName("ForwardTable")
        self.ForwardTableTitle = QtWidgets.QLabel(self.centralwidget)
        self.ForwardTableTitle.setGeometry(QtCore.QRect(190, 280, 101, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LsAlgoBtn.setText(_translate("MainWindow", "Create Control"))
        self.DvAlgoBtn.setText(_translate("MainWindow", "Create Normal"))
    ...
    def CreateNormal(self):
        ...
        try:
            ...
            return
        self.UIChangeOnStart()
        self.node =  route_node.CentralNormalNode(initinfo, obj_handler=self.handler, data_change_handler=self.change)
        self.NodeId.setText(str(self.node.node_id))
        self.node.start()
